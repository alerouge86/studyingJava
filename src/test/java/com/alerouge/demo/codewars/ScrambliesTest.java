...
class ScrambliesTest {
    ...
    public void sampleTests() {
        ...
        testing(Scramblies.scramble("cqsdaw","casa"), false);

        testing(Scramblies.scramble("cacqsdaw","casa"), true);


        testing(Scramblies.scramble("rkqodlw","world"), true);
        testing(Scramblies.scramble("ocqsdaw","caso"), true);
        testing(Scramblies.scramble("reqadlw","ale"), true);
        testing(Scramblies.scramble("rcqadoi","ciao"), true);
